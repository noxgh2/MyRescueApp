    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(UpdateEmergencyContacts.this, userdata.class);
                ...
                if((!Name.equals("") && !Relation.equals("") && !phone.equals(""))) {
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            PutData putData = new PutData("http://192.168.8.138/loginregister/UpdateEmergencyContacts.php", "POST", field, data);
                            if (putData.startPut()) {
                                if (putData.onComplete()) {
                                    progressBar.setVisibility(View.GONE);
                                    String result = putData.getResult();
                                    if(result.equals("Your emergency contacts has been successfully updated")){
                                        ...
                                        Toast.makeText(getApplicationContext(),result,Toast.LENGTH_SHORT).show();
                                    EditTextFullName.setText(result);
                                    }
                                }
                            }
                        }
